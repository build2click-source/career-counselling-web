...
export const metadata: Metadata = {
  title: "Career DNA — Psychometric Career Assessment",
  description: "Discover your ideal career path through science-backed personality, interests, and aptitude assessments.",
};
